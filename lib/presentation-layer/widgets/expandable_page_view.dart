import 'package:emekteb/presentation-layer/widgets/size_reporting_widget.dart';
...
class _ExpandablePageViewState extends State<ExpandablePageView> {
  ...
  double? get _currentSize => _sizes.isNotEmpty ? _sizes[_currentPage] : 0;

  double? get _previousSize => _sizes.isNotEmpty ? _sizes[_previousPage] : 0;
  ...
  void initState() {
    ...
    _currentPage = _pageController.initialPage.clamp(0, _sizes.isNotEmpty ? _sizes.length - 1 : 0 );
