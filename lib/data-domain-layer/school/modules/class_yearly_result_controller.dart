...
class ClassYearlyResultController
    extends BaseModel<ClassYearlyResultController> {
  String? code;
  String? message;
  Result? result;

  ClassYearlyResultController({this.code, this.message, this.result});
  ...
  @override
  ClassYearlyResultController fromJson(Map<String, dynamic> json) {
    return ClassYearlyResultController(
      code: json['code'],
